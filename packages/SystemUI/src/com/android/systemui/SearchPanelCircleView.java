...
public class SearchPanelCircleView extends FrameLayout {
    ...
    private void updateCircleRectRight(float offset, boolean useStaticSize) {
        ...
        if (mHorizontal) {
            ...
            left = (int) (getWidth() - left - circleSize); /*-50*/
            top = (int) (getHeight() - circleSize / 2 - offset - 100); /*-40*/
        }
    ...
    private void updateCircleRectLeft(float offset, boolean useStaticSize) {
        ...
        if (mHorizontal) {
            ...
            left = (int) ((left / 2) - (circleSize / 2) + 65);/*+50*/
            top = (int) (getHeight() - circleSize / 2 - offset - 100);/*-40*/
        }
    ...
    private void updateCircleRectRight1(float offset, boolean useStaticSize) {
        ...
        if (mHorizontal) {
            if (mLeftNavbar) {
                left = (int) (mBaseMargin + offset - circleSize);
            } else {
