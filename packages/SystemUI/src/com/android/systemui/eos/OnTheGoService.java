...
package com.android.systemui.eos.onthego;
...
import com.android.internal.util.eos.EOSUtils;
...
public class OnTheGoService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent == null || !EOSUtils.hasCamera(this)) {
            stopSelf();
    ...
    private void getCameraInstance(int type) throws RuntimeException, IOException {
        ...
        if (!EOSUtils.hasFrontCamera(this)) {
            mCamera = Camera.open();
            return;
        }
    ...
    private void createNotification(final int type) {
        ...
        if (type == 1 || type == 2) {
            final ComponentName cn = new ComponentName("com.android.systemui",
                    "com.android.systemui.eos.onthego.OnTheGoService");
